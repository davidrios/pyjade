...
expected_results = {
    "p Here is some #[strong: em text] and look at #[a(href='http://google.com') this link!]": [
        ...
        {'buffer': None, 'line': 1, 'type': 'text', 'inline_level': 0, 'val': u' Here is some '},
        ...
        {'buffer': None, 'line': 1, 'type': 'text', 'inline_level': 0, 'val': u' and look at '},
        ...
        {'buffer': None, 'line': 1, 'type': 'text', 'inline_level': 0, 'val': u''}],

    "p Other inline #[strong= 'test']": [
        {'buffer': None, 'line': 1, 'type': 'tag', 'inline_level': 0, 'val': u'p'},
        {'buffer': None, 'line': 1, 'type': 'text', 'inline_level': 0, 'val': u' Other inline '},
        {'buffer': None, 'type': 'tag', 'line': 1, 'inline_level': 1, 'val': u'strong'},
    ...
    "p Test #[|text line]": [
        {'buffer': None, 'line': 1, 'type': 'tag', 'inline_level': 0, 'val': u'p'},
        {'buffer': None, 'line': 1, 'type': 'text', 'inline_level': 0, 'val': u' Test '},
        {'buffer': None, 'type': 'string', 'line': 1, 'inline_level': 1, 'val': u'text line'},
        {'buffer': None, 'line': 1, 'type': 'text', 'inline_level': 0, 'val': u''}],

    "p Test buffered #[= map(str, zip('iln', 'nie')) + 'code']": [
        {'buffer': None, 'line': 1, 'type': 'tag', 'inline_level': 0, 'val': u'p'},
        {'buffer': None, 'line': 1, 'type': 'text', 'inline_level': 0, 'val': u' Test buffered '},
    ...
    "#[#[#[a a#[b #[i a] b]] d]e]": [
        {'buffer': None, 'line': 1, 'type': 'text', 'inline_level': 0, 'val': u''},
        {'buffer': None, 'type': 'text', 'line': 1, 'inline_level': 1, 'val': u''},
        {'buffer': None, 'type': 'text', 'line': 1, 'inline_level': 2, 'val': u''},
        {'buffer': None, 'type': 'tag', 'line': 1, 'inline_level': 3, 'val': u'a'},
        {'buffer': None, 'type': 'text', 'line': 1, 'inline_level': 3, 'val': u' a'},
        {'buffer': None, 'type': 'tag', 'line': 1, 'inline_level': 4, 'val': u'b'},
        {'buffer': None, 'type': 'text', 'line': 1, 'inline_level': 4, 'val': u' '},
        {'buffer': None, 'type': 'tag', 'line': 1, 'inline_level': 5, 'val': u'i'},
        {'buffer': None, 'type': 'text', 'line': 1, 'inline_level': 5, 'val': u' a'},
        {'buffer': None, 'type': 'text', 'line': 1, 'inline_level': 4, 'val': u' b'},
        {'buffer': None, 'type': 'text', 'line': 1, 'inline_level': 3, 'val': u''},
        {'buffer': None, 'type': 'text', 'line': 1, 'inline_level': 2, 'val': u' d'},
        {'buffer': None, 'type': 'text', 'line': 1, 'inline_level': 1, 'val': u'e'},
        {'buffer': None, 'line': 1, 'type': 'text', 'inline_level': 0, 'val': u''}],

    "p We can also #[strong combine #[em multiple #[img(src='http://jade-lang.com/style/logo.png')]]]": [
        {'buffer': None, 'line': 1, 'type': 'tag', 'inline_level': 0, 'val': u'p'},
        {'buffer': None, 'line': 1, 'type': 'text', 'inline_level': 0, 'val': u' We can also '},
        {'buffer': None, 'type': 'tag', 'line': 1, 'inline_level': 1, 'val': u'strong'},
        {'buffer': None, 'type': 'text', 'line': 1, 'inline_level': 1, 'val': u' combine '},
        {'buffer': None, 'type': 'tag', 'line': 1, 'inline_level': 2, 'val': u'em'},
        {'buffer': None, 'type': 'text', 'line': 1, 'inline_level': 2, 'val': u' multiple '},
    ...
    "#[strong start] line with #[i]\#[j] inline": [
        ...
        {'buffer': None, 'line': 1, 'type': 'text', 'inline_level': 0, 'val': u' line with '},
        {'buffer': None, 'type': 'tag', 'line': 1, 'inline_level': 1, 'val': u'i'},
        {'buffer': None, 'line': 1, 'type': 'text', 'inline_level': 0, 'val': u'#[j] inline'}],

    "p Another #[strong.lil#okf(acs=[1,2]) test [[with brackets]] [in#[='side']]]": [
        {'buffer': None, 'line': 1, 'type': 'tag', 'inline_level': 0, 'val': u'p'},
        {'buffer': None, 'line': 1, 'type': 'text', 'inline_level': 0, 'val': u' Another '},
        {'buffer': None, 'type': 'tag', 'line': 1, 'inline_level': 1, 'val': u'strong'},
        ...
        {'buffer': None, 'type': 'text', 'line': 1, 'inline_level': 1, 'val': u' test [[with brackets]] [in'},
...
p Test inline mixin #[+lala(123, 'lala inside inline')] end""": [
        ...
        {'buffer': None, 'line': 3, 'type': 'text', 'inline_level': 0, 'val': u' Test inline mixin '},
        {'inline_level': 1, 'val': u'lala', 'buffer': None, 'args': u"123, 'lala inside inline'", 'line': 1, 'type': 'call'},
        {'buffer': None, 'line': 3, 'type': 'text', 'inline_level': 0, 'val': u' end'}],

    "p only class #[.strong: em inline]": [
        {'buffer': None, 'line': 1, 'type': 'tag', 'inline_level': 0, 'val': u'p'},
        {'buffer': None, 'line': 1, 'type': 'text', 'inline_level': 0, 'val': u' only class '},
    ...
    "#[asdf.lol(fff)#[asdf]]": [
        ...
        {'buffer': None, 'inline_level': 1, 'line': 1, 'type': 'text', 'val': u''},
